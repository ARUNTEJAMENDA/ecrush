...
<body>
    ...
    <h2>daily posts</h2>
    <form action="week_with_ecrush.php" method="post" enctype="multipart/form-data">
        <table>
            <tr><td>Name:</td><td><input required type="text" name="oname"></td></tr>
            <tr><td>Date:</td><td><input required type="text" name="odate"></td></tr>
            <tr><td>file1:</td><td><input required type="file" name="of1"></td></tr>
            <tr><td>file2:</td><td><input required type="file" name="of2"></td></tr>
            <tr><td>file3:</td><td><input required type="file" name="of3"></td></tr>
        </table>
    ...
    <form action="special_wishes.php" method="post" enctype="multipart/form-data">
        <table>
            <tr><td>Name:</td><td><input required type="text" name="tname"></td></tr>
            <tr><td>Date:</td><td><input required type="text" name="tdate"></td></tr>
            <tr><td>file1:</td><td><input required type="file" name="tfile1"></td></tr>
            <tr><td>file2:</td><td><input required type="file" name="tfile2"></td></tr>
            <tr><td>file3:</td><td><input required type="file" name="tfile3"></td></tr>
            <tr><td>active</td><td><input required type="text" name="tactive"></td></tr>
        </table>
    ...
    <table>
        <?php
            ...
            //----------------
            echo '<tr><th>s.no</th><th>date</th><th>file1</th><th>file2</th><th>file3</th><th>active</th><th>operator</th></tr>';
    ...
    <form action="weekend_trivia.php" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr><td>WINNER-1(format:name_id_clg):</td><td><input required type="text" placeholder="xxx_xxxxx_xxxx"></td></tr>
            <tr><td>WINNER-2(format:name_id_clg):</td><td><input required type="text" placeholder="xxx_xxxxx_xxxx"></td></tr>
            <tr><td>WINNER-3(format:name_id_clg):</td><td><input required type="text" placeholder="xxx_xxxxx_xxxx"></td></tr>
        </table>
