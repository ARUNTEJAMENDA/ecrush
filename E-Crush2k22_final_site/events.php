    ...
    <section id="events" class="events">
      <div class="breadcrumbs" data-aos="fade-in">
        <div class="container mt-5 mb-5">
          <h2>Events</h2>
          <p class="mt-5">Our past defines us and some memories are unforgettable and remains heartwarming.
            E-Crush past events are always stepping stones for new spirit and new enthusiasm in everyone of us..
            You can have the details of those events of the past on this page . </p>
        </div>
      </div>
