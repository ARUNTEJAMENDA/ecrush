...
<body>
    ...
    <form action="apis/weekend_trivia.php" method="post" enctype="multipart/form-data">
        <br><table>
            ...
            <tr><td>WINNER-1(format:name_id_clg):</td><td><input required name="winner1" type="text" placeholder="xxx_xxxxx_xxxx"></td></tr>
            <tr><td>WINNER-2(format:name_id_clg):</td><td><input required name="winner2" type="text" placeholder="xxx_xxxxx_xxxx"></td></tr>
            <tr><td>WINNER-3(format:name_id_clg):</td><td><input required name="winner3" type="text" placeholder="xxx_xxxxx_xxxx"></td></tr>
            <tr><td>active</td><td><input required name="active" type="text"></td></tr>
        </table>
