  ...
  <main>
    <div class="breadcrumbs web-banner text-center" data-aos="fade-in">
      <div class="container mt-5 mb-5">
        <h2 class="text-uppercase"><b>Technical</b></h2>
        <p class="mt-5">This club is also one of the main pillars that handles all 
      technical support for the organisation. It provides video 
      contents etc.. in the website.</p>
      </div>
    </div>

    <p align="center" id="welcome" class="mt-5 mb-5 text-uppercase">WELCOME TO Technical PAGE OF E-CRUSH RGUKTN.......</p>
    <hr>
