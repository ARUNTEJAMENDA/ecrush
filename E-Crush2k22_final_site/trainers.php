...
<body>
  ...
  <main id="main">
    <!-- ======= Breadcrumbs ======= -->
    <!--  style="background-image:url(assets/img/banners/quiz.png) ;" -->
    <div class="breadcrumbs text-center" data-aos="fade-in">
      <div class="container mt-5 mb-5">
        <h2><b>Weekend Trivia</b></h2>
    ...
    <section>
      <div class="container">
        ...
        <div class="row text-center align-items-center">
          ...
          <div class="col-12 col-md-4">
            <div class="background-card mb-3 shadow">
               <img src="assets/img/trainers/award.png" class="image-style"style="height:100px ;width:100px;">
               <h3>Student Name</h3>
               <p>ID NO</p>
               <p>COLLEGE NAME</p>
            </div>
