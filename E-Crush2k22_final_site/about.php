  ...
  <main id="main">
    ...
    <div class="breadcrumbs text-center" data-aos="fade-in">
      <div class="container mt-5 mb-5">
        <h2><b>About Us</b></h2>
        <p class="mt-5">Est dolorum ut non facere possimus quibusdam eligendi voluptatem. Quia id aut similique quia voluptas sit quaerat debitis. Rerum omnis ipsam aperiam consequatur laboriosam nemo harum praesentium. </p>
      </div>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <p>
              ...
              the campus by our daily activities, events, sessions, talks and many more.</p>
          </div>
        </div>
...
<br>
    <section id="about" class="about">
      <div class="container" >
        <h1 class="main-heading">Faculty convenor</h1>
        <br>

        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-4 order-1 order-md-1" id="mentorimg" >
          <img src="assets/img/mentor.webp">
    ...
    <section>
      <div class="container">
        <h1 class="main-heading">Different Sections</h1>
        <div class="row">
